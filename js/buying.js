...
function setUpdate(i) {
    ...
    $("#to_buy").attr("value", $("#toUpdate" + String(i) + 'to_buy').val());
    $("#price").attr("value", $("#toUpdate" + String(i) + 'price').val());
...
function display(formData) {
    ...
    let content = '<table class="table"><thead><th>date&time</th><th>to_buy</th><th>price</th></thead><tbody>';
        ...
        for (let i in formData) {
            ...
            if (formData[i][0] == username.value) {
                ...
                content += '<tr><td colspan=8><form id="toUpdate' + String(i) + '" name="update_to_linked_form" style="display: none">' +
                    ...
                    '<input id="toUpdate' + String(i) + 'to_buy" type="text" name="to_buy" value="' + formData[i][2] + '" placeholder="to_buy" required>' +
                    '<input id="toUpdate' + String(i) + 'price" type="number" name="price" value="' + formData[i][3] + '" placeholder="price" required>' +
