    ...
    if (date.value == "") {
        for (let i in formData) {
            ...
            if (formData[i][0] == username.value) {
                ...
                '<input id="toUpdate' + String(i) + 'cal" type="number" name="cal" value="' + formData[i][3] + '" placeholder="cal" step="0.01">' +
                '<input id="toUpdate' + String(i) + 'protein" type="number" name="protein" value="' + formData[i][4] + '" placeholder="protein" step="0.01">' +
                '<input id="toUpdate' + String(i) + 'fat" type="number" name="fat" value="' + formData[i][5] + '" placeholder="fat" step="0.01">' +
                '<input id="toUpdate' + String(i) + 'carbohydrate" type="number" name="carbohydrate" value="' + formData[i][6] + '" placeholder="carbohydrate" step="0.01">' +
                '<input id="toUpdate' + String(i) + 'sugar" type="number" name="sugar" value="' + formData[i][7] + '" placeholder="sugar" step="0.01">' +
                '<input id="toUpdate' + String(i) + 'nacl" type="number" name="nacl" value="' + formData[i][8] + '" placeholder="nacl" step="0.01">' +
